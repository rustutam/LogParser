...
import backend.academy.command_line.converters.DateConverter;
...
public class CommandLineArgs {
    ...
    @Parameter(names = "--from", description = "Start date for filtering logs", converter = DateConverter.class)
    private LocalDateTime from;

    @Parameter(names = "--to", description = "End date for filtering logs", converter = DateConverter.class)
